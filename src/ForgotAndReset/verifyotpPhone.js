...
import { verifyPhoneNumber } from "../../API/LoginAuth";
import { useRef, useState } from "react";
import OTPTextInput from "react-native-otp-textinput";

const VerifyOTPPhone = ({ navigation, route }) => {
...
const callVerifyOTP = async () => {
    ...
    const response = await verifyPhoneNumber(phoneNumber, otpInput);
...
return (
    ...
    <ScrollView contentContainerStyle={{ paddingBottom: 200 }}>
        ...
        >
            Let’s verify your phoneNumber
        </Text>
        <Text style={{ textAlign: "center", marginTop: 10 }}>
            We have sent an Phone Number with a code to{" "}
